...
<form id="FRM_vf" class="form-horizontal" action="{{route('juego.update')}}" method="POST">
    ...
    <h1 id="OPT" style="display: none">
        <div class="form-check-inline">
            <input type="radio" class="form-check-input" id="opcion1" name="opcion" value="1" data-text="VERDADERO">&nbsp;Verdadero
            <label class="form-check-label" for="opcion1"></label>
        </div>
        <b>|&nbsp;</b>
        <div class="form-check-inline">
            <input type="radio" class="form-check-input" id="opcion2" name="opcion" value="0" data-text="FALSO">&nbsp;Falso
